...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `${siteUrl}/product`,
    images: ["/images/optimized/quercetin-plus-bottle-front-product.webp"]
  }
};
...
export default function ProductPage() {
  const productJsonLd = {
    ...
    image: [
      `${siteUrl}/images/optimized/quercetin-plus-bottle-front-product.webp`,
      `${siteUrl}/images/optimized/quercetin-plus-bottle-lifestyle-product.webp`,
      `${siteUrl}/images/optimized/quercetin-plus-label-full-product.webp`
    ],
        ...
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="mobile-safe-column mx-auto grid max-w-[20rem] gap-4 sm:max-w-sm lg:max-w-none">
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                {
                  src: "/images/optimized/quercetin-plus-bottle-lifestyle-thumb.webp",
                  alt: "AirKind Quercetin Plus lifestyle bottle render"
                },
                {
                  src: "/images/optimized/quercetin-plus-bottle-angle-thumb.webp",
                  alt: "AirKind Quercetin Plus angled bottle render"
                },
                {
                  src: "/images/optimized/quercetin-plus-front-label-thumb.webp",
